    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['code'], name='courses_cou_code_612388_idx'), models.Index(fields=['course_start'], name='courses_cou_course__8e7755_idx'), models.Index(fields=['course_end'], name='courses_cou_course__61b5be_idx')],
            },
        ),
    ]
